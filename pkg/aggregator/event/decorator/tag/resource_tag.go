...
func init() {
	manager.Global.Provide("resource-tagger", New)
}
...
func (options *options) Setup(fs *pflag.FlagSet) {
	...
	fs.StringSliceVar(&options.resourceTagMappings, "resource-tag-mapping", defaultTagMapping,
...
func (d *tagDecorator) Decorate(ctx context.Context, object util.ObjectRef, event *event.Event) {
